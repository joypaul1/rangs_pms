...
@extends('layouts.app')
@section('page-header')
<i class="menu-icon tf-icons bx bx-message-alt-add" style="margin:0;font-size:30px"></i> Permission Edit
@stop
                    ...
                    <form method="POST" action="{{ route('permission.update',$permission) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" id="name"
                                placeholder="Permission Name.." value="{{$permission->name}}" required>
                        </div>
